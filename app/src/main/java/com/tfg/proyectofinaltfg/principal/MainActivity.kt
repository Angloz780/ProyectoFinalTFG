...
class MainActivity : AppCompatActivity() {
    ...
    private fun downloadFakeMovies(): List<Section> {
        ...
        val fantasy4 = Movie("Harry Potter Y el Prsionero de Azkaban", "https://firebasestorage.googleapis.com/v0/b/ateneatfg.appspot.com/o/Imagenes%2FPrisioneroDeAzkaban.png?alt=media&token=7921de81-1a87-4b5e-a5a9-475d269a2efc")
        ...
        val christmas5 = Movie("El Cascanueces", "https://firebasestorage.googleapis.com/v0/b/ateneatfg.appspot.com/o/Imagenes%2Fcascanueces.jpg?alt=media&token=243030fa-7b6b-4cbc-bd32-61e57d2f6ba9")
        ...
        val comedy1 = Movie("Guerra de papás", "https://firebasestorage.googleapis.com/v0/b/ateneatfg.appspot.com/o/Imagenes%2FGuerraDePapas.webp?alt=media&token=b331359b-dda3-4b80-b1f8-ddb4241ae812")
        val comedy2 = Movie("Guerra de papás 2", "https://firebasestorage.googleapis.com/v0/b/ateneatfg.appspot.com/o/Imagenes%2FGuerraDePapas2.webp?alt=media&token=06fc9b7f-a40d-4f4f-a263-23b3c09eb2c2")
        ...
        val comedy6 = Movie("Family Guy", "https://firebasestorage.googleapis.com/v0/b/ateneatfg.appspot.com/o/Imagenes%2Ffamily%20guy.png?alt=media&token=6c2dbef0-6a59-4329-b29f-de1fd2629df4")
